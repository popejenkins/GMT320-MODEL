...
// Load buildings from GeoJSON and populate buildingEntities
function loadBuildings2() {
  Cesium.GeoJsonDataSource.load('Building.geojson', { clampToGround: false })
      .then(function (dataSource) {
          ...
          buildingEntities = buildingDataSource.entities.values.map(entity => {
              return {
                  name: entity.properties.name.getValue(),  // Use your correct property name
                  entity: entity
              };
          });

          console.log("Building entities loaded:", buildingEntities);

          // Populate dropdowns after buildings are loaded
